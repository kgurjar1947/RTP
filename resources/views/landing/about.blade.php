...
<!-- whatsapp start -->
	...
	<!-- /header -->		<main>
			<section class="hero_in contacts" style="background: url('https://appstacklabs.com/rtp_landing/img/about-us.png') center center/cover no-repeat !important;">
			<div class="wrapper">
				<div class="container">
					...
					<div class="row justify-content-between">
						<div class="col-lg-6 wow position-relative" data-wow-offset="150">
							<figure class="block-reveal">
								...
								<img src="https://appstacklabs.com/rtp_landing/img/about-img.png" class="img-fluid" alt="" style="width: 100%;height:690px;">
							</figure>
						</div>
						<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
				    	<img src="https://appstacklabs.com/rtp_landing/img/raghav-nalamada.jpg" class="img-fluid" alt="" style="width: 100%;">
