...
<!-- whatsapp start -->
	...
	<header class="header menu_fixed">
		...
		<nav id="menu" class="main-menu">
			<ul class="">
				...
				<li class="head-hover"><span class="span-hero"><a href="{{url('/contact')}}" style="color:#FFF !important;"><img src="https://rtppropertiesnc.com/img/contact_us_hover.png"/> <br/>Contact</a></span></li>
			</ul>
	...
	<!-- /header --><main>
		<section class="hero_in contacts" style="background: url('https://rtppropertiesnc.com/img/contact-banner.png') center center/cover no-repeat !important;">
			<div class="wrapper">
				<div class="container">
						<h1 class="fadeInUp animated" style="margin-top:80px;"><span></span>Contact Us</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
			...
			<div class="container">
				<ul class="clearfix">
					<li>
						...
						<h4>Address</h4>
						<span><a style="color:#FFF;" href="https://maps.app.goo.gl/6wnaCjNCsEu4ALPi9" target="_blank">5535 Western Blvd , Raleigh NC 27606 <br/>PO Box 21, Morrisville NC 27560</a></span>
					</li>
					<li>
						<i class="pe-7s-mail-open-file"></i>
						<h4>Email address</h4>
						<span><a style="color:#FFF;" href="mailto:rtprealtync@gmail.com">rtprealtync@gmail.com</a><br><small><a style="color:#FFF;" href="mailto:info@rtppropertiesnc.com">info@rtppropertiesnc.com</a></small></span>

					</li>
					<li>
						<i class="pe-7s-phone"></i>
						<h4>Contacts info</h4>
						<span><a style="color:#FFF;" href="tel:+1-877RTPRTP9">+1-877-RTP-RTP9</a><br><small>Monday to Friday 9am - 6pm</small></span>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="bg_color_1">
			<div class="container margin_80_55">
				<div class="row justify-content-between">
					<div class="col-lg-6">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3236.603182856487!2d-78.72220082535765!3d35.78512272426195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89acf45ca949a2a1%3A0x8a4081976d794c7a!2s5535%20Western%20Blvd%2C%20Raleigh%2C%20NC%2027606%2C%20USA!5e0!3m2!1sen!2sin!4v1710947175901!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label>Name</label>
										<input class="form-control" type="text" name="fname" id="full_name" >
									</div>
									<span id="full_name1" style="color:red;"></span>
								</div>
							</div>
							<!-- /row -->
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Telephone</label><span id="phone_tel" style="color:red;"></span>
										<input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Enter Number" />
									</div>
									 <span id="phone_number1" style="color:red;"></span>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>City</label>
								...
								<div class="col-md-6">
									<div class="form-group">
									 ...
									 <span id="subject1" style="color:red;"></span>
								</div>
							</div>
							<!-- /row -->
							<div class="form-group">
