...
<!--		</section>-->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="main_title_2">
							<span><em></em></span>
							<h3 style="color: #FFF; text-align: center;">WHY RENT WITH US</h3>
							<h6 style="color: #FFF !important; text-align: center;">Hastle free policies & best services
								makes your lives peaceful</h6>

						</div>
					</div>
				</div>
				<div class="rent-seaction" style="">
					<div class="row">
						<div class="col-lg-6 build-content wow position-relative animated" data-wow-offset="250"
							style="">
							<div class="row block-reveal_list" style="float: left !important;">
								<!-- <div class="block-vertical"></div> -->
								<div class="box_2 col-lg-12">
									<div class="row">
		...
		<div class="container margin_80_55">
			<div class="main_title_2">
				<span><em></em></span>
				<h2>RESIDENT BENEFITS</h2>
				<p>Experience unparalleled perks as a resident with RTP PROPERTIES NC INC. We are committed to ensuring
					an exceptional living experience for all our residents, offering a range of exclusive benefits
					tailored to elevate your stay with us. </p>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#0" style="height: 355px;">
						...
						<p>Home ownership is a dream come true for many renters. We will help you with getting
							...
							new home, and pay you up to $2000 in closing costs when you use our brokerage - a team of
							talented and experienced agents </p>
					</a>
				</div>
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#0" style="height: 355px;">
				...
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#0" style="height: 355px;">
						...
						<p>Feel the distinction in renting from us. Before you move in, we meticulously attend to all
							...
							homes include various appliances for your added convenience. </p>
					</a>
				</div>
			</div>
			<!--/row-->
					...
					<div class="row align-items-center">
						<div class="col-lg-3  mt-6 ">
							...
							<div class="container content-listing">
								...
								<p>We would be more than happy to discuss your needs and are available to show a home at
									virtually any time. Please reach out to us if we can be of any service to you or
									...
									<div class="row">
										...
										<div class="fadeIn col-md-6">
											<div class="formgroup">
												...
												<span id="f_name1" style="color:red;"></span>
											</div>
										</div>
										<div class="fadeIn col-md-6">
											<div class="formgroup">
												...
												<span id="l_name1" style="color:red;"></span>
											</div>
										</div>
										<div class="fadeIn col-md-6">
											<div class="formgroup">
												<label>Phone Number</label><span id="phone_te" style="color:red;"></span>
												<input type="text" name="phone" id="phone" class="form-control" placeholder="Enter Number" />
										...
										<div class="fadeIn col-md-6">
											<div class="formgroup">
												<label>Email</label>
												<input type="email" name="gmail" id="gmail" class="form-control" placeholder="Enter Email" />
												<span id="gmail1" style="color:red;"></span>
											</div>
										</div>
									</div>

									<div class="fadeIn formgroup">
										<label>Message</label>
